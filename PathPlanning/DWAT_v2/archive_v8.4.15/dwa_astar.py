...
# fig_folder = 'figs_v8.4.17-v2-vid1'
# map_config_file = os.path.join("PathPlanning", "DWAT_v2", "map_config", "map_config_video1-test1.json")
fig_folder = 'figs_v8.4.15-v2-vid2'
map_config_file = os.path.join("PathPlanning", "DWAT_v2", "map_config", "map_config_video2.json")
# fig_folder = 'figs_v8.2.3-simple4'
# map_config_file = os.path.join("PathPlanning", "DWAT_v2", "map_config", "map_config_simple4.json")
