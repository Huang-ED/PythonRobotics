...
v8: Normalization of the three costs (to goal, obstacle, speed). 
"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        """, UserWarning)
                ...
                ## Execute DWA
                u, predicted_trajectory, dw, admissible, inadmissible, to_goal_before, speed_before, ob_before, to_goal_after, speed_after, ob_after, final_cost = dwa.dwa_control_norm(x, config, dwagoal, ob_dwa)
