...
try:
    # Change import to the correct file used in dwa_astar.py
    from dwa_average_weighted_side import (
        ...
        # Use the correct function available in dwa_average_weighted_side.py
    ...
    for i in range(V.shape[0]):
        for j in range(V.shape[1]):
            ...
            if has_dynamic:
                ...
                # It does NOT return indices_arr, so we must calculate d_direct manually for all points
