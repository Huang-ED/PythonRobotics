...
import dwa_average_weighted_side as dwa
from dwa_average_weighted_side import Config, line_circle_intersection
...
fig_folder = 'figs_v20.6-scenario1' # New folder for merged results
map_config_file = os.path.join("PathPlanning", "DWAT_v4_st", "map_config", "scenario_1.json")
    ...
    try:
        for i_turning_point, turning_point in enumerate(road_map):
            ...
            while True:
                ...
                # --- NEW: Get Dynamic Obstacle Velocities ---
