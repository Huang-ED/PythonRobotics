...
def main():
    ...
    log_file_path = "Logs/figs_v20.3.4-video1.1_20260115_200511/log_details.csv" 
    map_config_file = "PathPlanning/DWAT_v4_st/map_config/map_config_video1.1.json"
    
    iter_nums = list(range(860, 870))  # Specify iterations
    # ---------------------
